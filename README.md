...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,476 | 🐛 20 | 🌐 Python | 📅 2026-09-16 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,095 | 🐛 82 | 🌐 Meson | 📅 2026-09-22 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,103 | 🐛 589 | 🌐 Shell | 📅 2026-09-21 - Material icon theme, initially based on Paper.
