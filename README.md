...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,465 | 🐛 22 | 🌐 Python | 📅 2026-09-01 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,243 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,081 | 🐛 80 | 🌐 Meson | 📅 2026-09-08 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,064 | 🐛 586 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 4,013 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,267 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Collections of awesome native open-source GTK (4 and 3) applications.
