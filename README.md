...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,461 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,224 | 🐛 137 | 🌐 Rust | 📅 2026-08-31 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,082 | 🐛 80 | 🌐 Meson | 📅 2026-09-03 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,056 | 🐛 586 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,997 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,898 | 🐛 54 | 🌐 CSS | 📅 2026-07-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,270 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - Collections of awesome native open-source GTK (4 and 3) applications.
