...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,460 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,589 | 🐛 16 | 🌐 CSS | 📅 2026-08-02 skin installer.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,217 | 🐛 136 | 🌐 Rust | 📅 2026-08-31 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,080 | 🐛 80 | 🌐 Meson | 📅 2026-09-03 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,052 | 🐛 584 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) ⭐ 933 | 🐛 5 | 📅 2026-02-21 - Flat rounded icon theme.
...
* [Elementary XFCE](https://github.com/shimmerproject/elementary-xfce) ⭐ 297 | 🐛 33 | 🌐 C | 📅 2026-01-02 - Desktop-agnostic version of the icons of elementary OS.

### Cursors

* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,993 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,230 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,899 | 🐛 54 | 🌐 CSS | 📅 2026-07-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,589 | 🐛 16 | 🌐 CSS | 📅 2026-08-02 - Skin to make Steam look more like a native GNOME app.
...
* [Adwaita theme for VS Code](https://github.com/piousdeer/vscode-adwaita) ⭐ 183 | 🐛 12 | 🌐 Python | 📅 2024-08-04 - Dark and light themes for VS Code based on GNOME's look and GNOME Builder's syntax highlighting.
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 175 | 🐛 4 | 🌐 SCSS | 📅 2026-08-29 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,270 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Collections of awesome native open-source GTK (4 and 3) applications.
