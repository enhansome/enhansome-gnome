...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,443 | 🐛 20 | 🌐 Python | 📅 2026-08-18 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,075 | 🐛 86 | 🌐 Meson | 📅 2026-08-13 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,020 | 🐛 578 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,934 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
