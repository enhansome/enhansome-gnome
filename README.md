...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,450 | 🐛 19 | 🌐 Python | 📅 2026-08-25 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,160 | 🐛 129 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,079 | 🐛 88 | 🌐 Meson | 📅 2026-08-25 - An Adwaita-style icon theme for Gnome Shell.
* [Pop!](https://github.com/pop-os/icon-theme) ⭐ 217 | 🐛 16 | 🌐 Python | 📅 2024-10-01 - Official icon theme of Pop!\_OS by System76.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,036 | 🐛 581 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,956 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 172 | 🐛 4 | 🌐 SCSS | 📅 2026-08-19 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,266 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Collections of awesome native open-source GTK (4 and 3) applications.
