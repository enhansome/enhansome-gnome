...
* [Netsleuth](https://github.com/vmkspv/netsleuth) ⭐ 55 | 🐛 1 | 🌐 Python | 📅 2026-07-19 - Utility for the calculation and analysis of IP subnet values.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,449 | 🐛 22 | 🌐 Python | 📅 2026-08-20 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,583 | 🐛 16 | 🌐 CSS | 📅 2026-08-02 skin installer.
* [Dynamic Gnome Wallpapers](https://github.com/manishprivet/dynamic-gnome-wallpapers) ⭐ 502 | 🐛 11 | 🌐 Shell | 📅 2024-11-01 - Gallery of MacOS like dynamic wallpapers, and easy scripts to install them
* [Luminance](https://github.com/sidevesh/Luminance) ⭐ 177 | 🐛 11 | 🌐 C | 📅 2026-08-09 - Simple application to control brightness of displays (including external) supporting DDC/CI.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,149 | 🐛 129 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch).
...
* [Escambo](https://github.com/CleoMenezesJr/escambo) ⭐ 145 | 🐛 19 | 🌐 Python | 📅 2024-05-01 - HTTP-based APIs test application.
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,077 | 🐛 87 | 🌐 Meson | 📅 2026-08-19 - An Adwaita-style icon theme for Gnome Shell.
* [Pop!](https://github.com/pop-os/icon-theme) ⭐ 217 | 🐛 15 | 🌐 Python | 📅 2024-10-01 - Official icon theme of Pop!\_OS by System76.
* [GNOME++](https://github.com/Bonandry/gnome-plus) ⭐ 173 | 🐛 9 | 🌐 Shell | 📅 2023-03-03 - Third-party application icons compatible with GNOME's current guidelines.
...
* [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) ⭐ 1,992 | 🐛 115 | 🌐 Shell | 📅 2021-11-25 - Icon inspired by macOS and Material Design guidelines.
...
* [Elementary XFCE](https://github.com/shimmerproject/elementary-xfce) ⭐ 295 | 🐛 33 | 🌐 C | 📅 2026-01-02 - Desktop-agnostic version of the icons of elementary OS.

### Cursors

* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,940 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,228 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,895 | 🐛 52 | 🌐 CSS | 📅 2026-07-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,583 | 🐛 16 | 🌐 CSS | 📅 2026-08-02 - Skin to make Steam look more like a native GNOME app.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 169 | 🐛 4 | 🌐 SCSS | 📅 2026-08-19 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,265 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Collections of awesome native open-source GTK (4 and 3) applications.
