...
* [Netsleuth](https://github.com/vmkspv/netsleuth) ⭐ 56 | 🐛 2 | 🌐 Python | 📅 2026-09-22 - Utility for the calculation and analysis of IP subnet values.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,475 | 🐛 20 | 🌐 Python | 📅 2026-09-16 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,307 | 🐛 144 | 🌐 Rust | 📅 2026-09-21 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,095 | 🐛 82 | 🌐 Meson | 📅 2026-09-21 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,100 | 🐛 589 | 🌐 Shell | 📅 2026-09-21 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 4,133 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,904 | 🐛 57 | 🌐 CSS | 📅 2026-07-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
