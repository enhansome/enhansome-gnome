...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,442 | 🐛 20 | 🌐 Python | 📅 2026-08-12 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,579 | 🐛 14 | 🌐 CSS | 📅 2026-08-02 skin installer.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,136 | 🐛 128 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,074 | 🐛 86 | 🌐 Meson | 📅 2026-08-13 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,016 | 🐛 575 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,932 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,893 | 🐛 52 | 🌐 CSS | 📅 2026-07-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,262 | 🐛 4 | 🌐 Python | 📅 2026-08-11 - Collections of awesome native open-source GTK (4 and 3) applications.
