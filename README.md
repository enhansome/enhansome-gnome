...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,447 | 🐛 20 | 🌐 Python | 📅 2026-08-20 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,582 | 🐛 15 | 🌐 CSS | 📅 2026-08-02 skin installer.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,146 | 🐛 129 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch).
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,029 | 🐛 579 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,938 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,227 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
...
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,582 | 🐛 15 | 🌐 CSS | 📅 2026-08-02 - Skin to make Steam look more like a native GNOME app.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,263 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Collections of awesome native open-source GTK (4 and 3) applications.
